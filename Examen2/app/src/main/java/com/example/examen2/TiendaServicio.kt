...
import kotlinx.android.synthetic.main.activity_tienda_servicio.listView10

class TiendaServicio : AppCompatActivity() {
    private val db = FirebaseFirestore.getInstance()
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_tienda_servicio)
        ...
        buscarServicio3.setOnClickListener{
            val adapter: ArrayAdapter<String> = ArrayAdapter(this, android.R.layout.simple_list_item_1
                ,servicio )
            listView10.adapter=adapter

            busServicio3.setOnQueryTextListener(object: SearchView.OnQueryTextListener {
                override fun onQueryTextSubmit(p0: String?): Boolean {
                    busServicio3.clearFocus()
        ...
        actualizarServicios3.setOnClickListener{
                db.collection("Servicios").whereEqualTo("Nombre del negocio",nombreNegocio).get()
            ...
            listView10.adapter = myListAdapter
            listView10.setOnItemClickListener(){adapterView, view, position, id ->
