...
class ProductoCliente : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buscarProductoCliente.setOnClickListener{
            val adapter: ArrayAdapter<String> = ArrayAdapter(this, android.R.layout.simple_list_item_1
                ,producto)
            listView6.adapter=adapter

            busProductoCliente.setOnQueryTextListener(object: SearchView.OnQueryTextListener {
                override fun onQueryTextSubmit(p0: String?): Boolean {
                    busProductoCliente.clearFocus()
        ...
        actualizarProductoCliente.setOnClickListener{
            db.collection("Productos").whereEqualTo("Visibilidad","Si").get()
            ...
            listView6.adapter = myListAdapter
